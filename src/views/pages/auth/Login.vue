        ...
        <div class="flex flex-col items-center justify-center">
            ...
            >
                <div class="w-full bg-surface-0 px-8 py-20 sm:px-20 dark:bg-surface-900" style="border-radius: 53px">
                    ...
                    <div>
                        <label for="email1" class="mb-2 block text-xl font-medium text-surface-900 dark:text-surface-0"
                            >Email</label
                        >
                        <InputText
                            id="email1"
                        ...
                        <div class="mb-8 mt-2 flex items-center justify-between gap-8">
                            ...
                            <span class="ml-2 cursor-pointer text-right font-medium text-primary no-underline"
