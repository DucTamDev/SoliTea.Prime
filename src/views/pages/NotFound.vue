...
import FloatingConfigurator from '@/components/configurator/FloatingConfigurator.vue';
</script>
        ...
        <div class="flex flex-col items-center justify-center">
            ...
            >
                ...
                >
                    ...
                    <h1 class="mb-2 text-3xl font-bold text-surface-900 lg:text-5xl dark:text-surface-0">Not Found</h1>
                    ...
                    >
                        ...
                        <span class="ml-6 flex flex-col">
                            <span class="mb-0 block font-medium text-surface-900 lg:text-xl dark:text-surface-0"
                    ...
                    >
                        ...
                        <span class="ml-6 flex flex-col">
                            <span class="mb-0 font-medium text-surface-900 lg:text-xl dark:text-surface-0"
