...
import { PhotoServiceStatic } from '@/statics/PhotoServiceStatic';
...
onMounted(() => {
    ProductServiceStatic.getProductsSmall().then((data) => (products.value = data));
    PhotoServiceStatic.getImages().then((data) => (images.value = data));
});
    ...
    <div class="card">
        ...
        <Carousel :value="products" :numVisible="3" :numScroll="3" :responsiveOptions="carouselResponsiveOptions">
            <template #item="slotProps">
                <div class="m-2 rounded border border-surface-200 p-4 dark:border-surface-700">
                    <div class="mb-4">
