...
import { CountryServiceStatic } from '@/statics/CountryServiceStatic';
import { NodeServiceStatic } from '@/statics/NodeServiceStatic';
import { onMounted, ref } from 'vue';

const floatValue = ref(null);
const autoValue = ref(null);
const selectedAutoValue = ref(null);
const autoFilteredValue: any = ref([]);
...
onMounted(() => {
    CountryServiceStatic.getCountries().then((data: any) => (autoValue.value = data));
    NodeServiceStatic.getTreeNodes().then((data: any) => (treeSelectNodes.value = data));
});
