...
import { CustomerServiceStatic } from '@/statics/CustomerServiceStatic';
...
onBeforeMount(() => {
    ProductServiceStatic.getProductsWithOrdersSmall().then((data) => (products.value = data));
    CustomerServiceStatic.getCustomersLarge().then((data) => {
        customers1.value = data;
        loading1.value = false;
        customers1.value.forEach((customer) => (customer.date = new Date(customer.date)));
    });
    CustomerServiceStatic.getCustomersLarge().then((data) => (customers2.value = data));
    CustomerServiceStatic.getCustomersMedium().then((data) => (customers3.value = data));
