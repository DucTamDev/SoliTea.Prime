<template>
    <div class="container mx-auto px-4 py-5">
        ...
        <section class="mx-auto mb-8 max-w-7xl sm:mb-12">
            <SectionTitle title="Lợi ích chọn thương hiệu Soli" color="text-teal-700" :delay="200" />
...
import FranchiseEstimatedCost from '@/components/franchise/financials/FranchiseEstimatedCost.vue';
import FranchiseExpectedProfit from '@/components/franchise/financials/FranchiseExpectedProfit.vue';
import FranchiseBenefit from '@/components/franchise/presentation/FranchiseBenefit.vue';
import FranchiseOnboarding from '@/components/franchise/presentation/FranchiseOnboarding.vue';
</script>
