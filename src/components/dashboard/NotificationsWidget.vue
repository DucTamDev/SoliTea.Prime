    ...
    <div class="card">
        ...
        <ul class="mx-0 mb-6 mt-0 list-none p-0">
            <li class="flex items-center border-b py-2 border-surface">
                ...
                <span class="leading-normal text-surface-900 dark:text-surface-0"
                    ...
                    <span class="text-surface-700 dark:text-surface-100"
                        >has purchased a blue t-shirt for <span class="font-bold text-primary">$79.00</span></span
                    >
                </span>
            </li>
            <li class="flex items-center py-2">
                ...
                <span class="leading-normal text-surface-700 dark:text-surface-100"
                    >Your request for withdrawal of <span class="font-bold text-primary">$2500.00</span> has been
                    initiated.</span
                >
            </li>
        </ul>
        ...
        <ul class="m-0 mb-6 list-none p-0">
            <li class="flex items-center border-b py-2 border-surface">
                ...
                <span class="leading-normal text-surface-900 dark:text-surface-0"
                    >Keyser Wick
                    <span class="text-surface-700 dark:text-surface-100"
                        >has purchased a black jacket for <span class="font-bold text-primary">$59.00</span></span
                    >
                </span>
            </li>
            <li class="flex items-center border-b py-2 border-surface">
        ...
        <ul class="m-0 list-none p-0">
            <li class="flex items-center border-b py-2 border-surface">
                ...
                <span class="leading-normal text-surface-900 dark:text-surface-0"
                    >Your revenue has increased by <span class="font-bold text-primary">%25</span>.</span
                >
            </li>
            <li class="flex items-center border-b py-2 border-surface">
                <div
                ...
                <span class="leading-normal text-surface-900 dark:text-surface-0"
                    ><span class="font-bold text-primary">12</span> users have added your products to their
                    wishlist.</span
                >
            </li>
        </ul>
